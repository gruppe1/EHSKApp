...
/**
 * Helper class for showing and canceling pop up notifications.
 * <p>
...
public class PopUpNotification {
	 ...
	 */
	private static final String NOTIFICATION_TAG = "PopUp";
	 ...
	 * presentation of pop up notifications. Make sure to follow the <a
	...
	public static void notify(final Context context,
		...
		final String title = res.getString(
				R.string.pop_up_notification_title_template, exampleString);
		final String text = res.getString(
				R.string.pop_up_notification_placeholder_text_template,
				exampleString);
